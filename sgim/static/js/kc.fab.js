        ...
        base.init = function(){
            ...
            if (base.links.length > 0){
                ...
                for (var i = 0; i < base.links.length; i++) {
                    ...
                    sub_fab_btns_dom += "<div><button data-link-href='"+(base.links[i].url?base.links[i].url:"")+"' data-link-target='"+((base.links[i].target)?base.links[i].target:"")+"' class='sub_fab_btn' style='"+bg_color_style+"'  id='"+base.links[i].id+"'><span style='"+color_style+"'>"+base.links[i].icon+"</span></button></div>"; 
