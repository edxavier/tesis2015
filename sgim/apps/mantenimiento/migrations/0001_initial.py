    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duracion_estimada', models.FloatField(default=1, help_text=b'Duracion en horas (puede indicarse con punto decimal)', verbose_name=b'Duracion Estimada')),
                ('creador', models.ForeignKey(to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valor_ref', models.CharField(help_text=b'Valor de referencia', max_length=100)),
                ('creador', models.ForeignKey(to=settings.AUTH_USER_MODEL)),
